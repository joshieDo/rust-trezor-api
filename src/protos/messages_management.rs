...
pub struct Features {
    ...
    // @@protoc_insertion_point(field:hw.trezor.messages.management.Features.fw_vendor_keys)
    pub fw_vendor_keys: ::std::option::Option<::std::vec::Vec<u8>>,
...
impl Features {
    ...
    pub fn clear_fw_vendor_keys(&mut self) {
        self.fw_vendor_keys = ::std::option::Option::None;
    }
    ...
    pub fn set_fw_vendor_keys(&mut self, v: ::std::vec::Vec<u8>) {
        self.fw_vendor_keys = ::std::option::Option::Some(v);
    }
    ...
    pub fn mut_fw_vendor_keys(&mut self) -> &mut ::std::vec::Vec<u8> {
        if self.fw_vendor_keys.is_none() {
            self.fw_vendor_keys = ::std::option::Option::Some(::std::vec::Vec::new());
        }
...
impl ::protobuf::Message for Features {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                210 => {
                    self.fw_vendor_keys = ::std::option::Option::Some(is.read_bytes()?);
                },
                216 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let Some(v) = self.fw_vendor_keys.as_ref() {
    ...
    fn default_instance() -> &'static Features {
        static instance: Features = Features {
            ...
            fw_vendor_keys: ::std::option::Option::None,
